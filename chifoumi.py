...
def determine_result(user_choice, computer_choice):
    rules = {
        'pierre': {'pierre': '⚖️ égalité', 'feuille': '☠️ défaite', 'ciseaux': '🎉 victoire'},
        'feuille': {'pierre': '🎉 victoire', 'feuille': '⚖️ égalité', 'ciseaux': '☠️ défaite'},
        'ciseaux': {'pierre': '☠️ défaite', 'feuille': '🎉 victoire', 'ciseaux': '⚖️ égalité'}
    }
